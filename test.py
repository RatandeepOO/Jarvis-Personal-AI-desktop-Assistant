...
class Assistant:
    ...
    def get_user_name(self):
        self.speak("Hello, what would you like to call me?")
        self.user_name = self.take_command().split()[0]
        self.speak(f"Nice to meet you, {self.user_name}. You can call me by saying my name first.")
    ...
    def run_assistant(self):
        self.get_user_name()  # Get user name at startup
